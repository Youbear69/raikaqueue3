...
const T = {
  th: {
    ...
    forgot: 'ลืมรหัสผ่าน?',
    resetSent: 'ถ้าอีเมลนี้มีบัญชีอยู่ ระบบส่งลิงก์รีเซ็ตรหัสผ่านให้แล้ว (เช็คกล่องสแปมด้วย)',
  ...
  en: {
    ...
    resetSent: 'If this email has an account, a reset link was sent (check your spam folder)',
